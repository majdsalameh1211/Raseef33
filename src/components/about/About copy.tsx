...
export default function About() {
    return (
        <section id="about" className="about-section">
            {/* Blurred bg image — same system as Menu section */}
            <div className="about-blurred-bg" />

            {/* Dark warm overlay — matches Menu exactly */}
        ...
        /* ── Blurred bg — identical to Menu section ── */
        .about-blurred-bg {
          position: absolute;
          inset: -10%;
        ...
        /* ── Overlay — identical to Menu section ── */
        .about-overlay {
          position: absolute;
          inset: 0;
